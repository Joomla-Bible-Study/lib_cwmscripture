...
((Joomla) => {
     ...
     */
    function getBooks() {
        return Joomla.getOptions('cwmscripture.books') || [];
    }
    ...
    function getStructure() {
        return Joomla.getOptions('cwmscripture.bibleStructure') || {};
    }
    ...
    function getDefaultVersion() {
        return Joomla.getOptions('cwmscripture.defaultBibleVersion') || '';
    }
